...
public class ArticleWritingProxy {
	private final String TAG = ArticleWritingProxy.class.getSimpleName();
	private String lineEnd = "\r\n";
	private String twoHyphens = "--";
	private String boundary = "*****";

	public String uploadArticle(ArticleDTO article, String filePath) {
		...
		try {
			...
			URL url = new URL("http://10.73.44.93/~stu20/upload.php");
			...
			// Content는 multipart형식이고 데이터의 끝을 boundary(*****)로 표시를
			// 하겠다.(content-length이 없으므로...)
